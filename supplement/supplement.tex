...
\setcounter{table}{8}
\setcounter{figure}{3}
% Shift the reference numbers.
% \newcounter{reference} \setcounter{reference}{16}
% \DeclareFieldFormat{labelnumber}{\number\numexpr#1+\value{reference}\relax}
...
\section{Development and analysis of transmission models}
...
% Supplemental results figures, not referenced in the text above.
\clearpage

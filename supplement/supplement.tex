...
% This looks like '(PRCC; 72, 74)'.
% Take care if the citation style changes.
...
studies (sections S2, S3; Table S1; Fig.~2).
...
% This looks like 'Hedger (1972, Table S4)'.
% Take care if the citation style changes.

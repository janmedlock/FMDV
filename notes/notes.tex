...
\title{Supplementary Material for\\
  \emph{Endemic dynamics of foot-and-mouth disease viruses in their
    reservoir, African buffalo} \\
...
\begin{figure}
  \centering
  \includegraphics{../plot_population_sizes}
  \caption{The sensitivity of extinction time to buffalo population
    size.
    ...
    10-year period for the chronic model.}
\end{figure}

\begin{figure}
  \centering
  \includegraphics{../plot_birth_seasonality}
...
\begin{figure}
  \centering
  \input{../plot_samples_sensitivity_acute.pgf}
  \caption{The sensitivity of extinction time to the parameters, for
    the model with only acute transmission.  The graphs show, for each
    SAT, the sensitivity, measured by the partial rank correlation
    coefficient (PRCC) \autocite{blower_1994}, of FMDV extinction time
    to model parameters.
    The model was simulated with each of 20,000 samples from the
    posterior distributions of the parameters (Fig.~2; Tables S2, S3).}
\end{figure}
